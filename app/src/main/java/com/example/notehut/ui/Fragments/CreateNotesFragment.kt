...
import com.example.notehut.databinding.FragmentCreateNotesBinding
import java.util.*
...
class CreateNotesFragment : Fragment() {
    ...
    private fun createNotes(it:View?){
        ...
        Navigation.findNavController(it!!).navigate(R.id.action_createNotesFragment_to_homeFragment) // after making note return to home fragment
    }
